  ...
  return html`
    <ud-layout>
      ...
      <section class="columns">
        ...
        <ud-callout-box class="column" icon="wand-magic-sparkles">
        ...
        <ud-callout-box class="column" icon="map">
      ...
      <section class="columns">
        <ud-callout-box class="column" icon="user-shield">
        ...
        <ud-callout-box class="column" icon="quote-left">
